 ...
 * @author cgpre
 */
@WebServlet("/ListarColecoes")
public class ListarColecoes extends HttpServlet {
...
//            out.println("<link rel=\"stylesheet\" href=\"../resources/css/estilo.css\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListarColecoes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
