 ...
 * @author cgpre
 */
public class GerenciarTipos extends HttpServlet {
    ...
    private void pesquisar() throws Exception {
        ...
        tabela = "<div class=\"frmPesquisa\">\n"
                + "<table><tr><th>Classe</th><th>Rótulo</th><th>Descrição</th><th>Alterar</th><th>Excluir</th></tr>";
        for (int i = 0; i < list.size(); i++) {
            ...
            tabela = tabela + "<tr>"
                    ...
                    + "<td><button type=\"submit\" value=\"\">Alterar</button></td>"
                    + "<td><button type=\"submit\" value=\"\">Excluir</button></td>"
                    + "</tr>\n";
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GerenciarTipos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
